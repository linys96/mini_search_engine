...
//用宏缩短并简化函数调用形式
#define logError(msg) mylog.error(suffix(msg))
#define logWarn(msg) mylog.warn(suffix(msg))
#define logInfo(msg) mylog.info(suffix(msg))
#define logDebug(msg) mylog.debug(suffix(msg))
